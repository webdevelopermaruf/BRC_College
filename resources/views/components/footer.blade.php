            ...
            <div class="row">
                    ...
                    <div class="footer-widget footer-widget-2">
                        ...
                        <div class="footer-menu">
                            <ul>
                                ...
                                <li><a href="index-six.html#">Events</a></li>
                                <li><a href="index-six.html#">Career</a></li>
                ...
                <div class="col-lg-4 md-mb-30">
                    <div class="footer-widget footer-widget-3">
                        ...
                        <div class="footer-menu">
                            <ul>
                                <li><a href="index-six.html#">Browse Library</a></li>
                                <li><a href="index-six.html#">Library</a></li>
                                <li><a href="index-six.html#">Partners</a></li>
                                <li><a href="blog.html">News & Blog</a></li>
                                <li><a href="index-six.html#">FAQ</a></li>
                                <li><a href="index-six.html#">Tutorials</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="react-copy-right">
                <ul class="social-links">
                    ...
                    <li><a href="index-six.html#"><span aria-hidden="true" class="social_facebook"></span></a>
                    </li>
                    <li><a href="index-six.html#"><span aria-hidden="true" class="social_twitter"></span></a>
                    </li>
                    <li><a href="index-six.html#"><span aria-hidden="true" class="social_linkedin"></span></a>
                    </li>
                </ul>
            </div>
        </div>
